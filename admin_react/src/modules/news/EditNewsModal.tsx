...
interface EditNewsModalProps {
  ...
  onClose: () => void;
  onSubmit: (id: number, data: NewsFormData) => Promise<{ success: boolean; error?: string }>;
...
export function EditNewsModal({ isOpen, newsItem, onClose, onSubmit, showToast }: EditNewsModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        showToast(t('msg.news_updated'), 'success');
        onClose();
      } else {
        showToast(res.error || t('msg.error_update_news'), 'error');
      }
    } finally {
