...
class LanguageService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      'direct_service_title': 'طلب واستفسار مباشر',
      'direct_service_desc': 'هذه الخدمة لا تتطلب تعبئة نموذج، يمكنك التواصل مباشرة أو إرسال طلب فوري.',
      'direct_order_btn': 'إرسال طلب فوري بنقرة واحدة',
      'contact_whatsapp': 'تواصل عبر واتساب',
      'contact_chat': 'محادثة الدعم الفني',
      'optional_notes': 'ملاحظات أو تفاصيل إضافية (اختياري)',
      'service_order_success': 'تم إرسال طلبك بنجاح وسيتواصل معك الدعم قريباً!',
      'app_title': 'أبشر',
      'welcome': 'مرحباً بك،',
      'home': 'الرئيسية',
      'services': 'الخدمات',
      ...
      'delete_all_notifs': 'حذف جميع الإشعارات',
      'delete_all_confirm_title': 'حذف جميع الإشعارات',
      'delete_all_confirm_msg': 'هل أنت متأكد من رغبتك في حذف كافة الإشعارات والتنبيهات؟',
      'delete_notif_success': 'تم حذف الإشعار',
      'delete_all_notifs_success': 'تم حذف جميع الإشعارات بنجاح',
      'delete_notif_btn': 'حذف',
      ...
      'about_description':
          'مجموعة أبشر للخدمات الطلابية والتعليمية في جورجيا - بوابتك للدراسة والسكن والاستقرار الجامعي في جورجيا، ومساعدتك في القبول الجامعي والسكن والخدمات الطلابية المتكاملة من البداية حتى التخرج.',
      'supported_languages_title': 'اللغات المدعومة',
      'contact_us_title': 'قنوات التواصل الرسمية',
      'website_label': 'الموقع الإلكتروني الرسمي',
      'whatsapp_label': 'رقم الواتساب والاتصال',
      'instagram_label': 'حساب الإنستجرام',
      'facebook_label': 'صفحة الفيسبوك',
      'tiktok_label': 'حساب التيك توك',
      'youtube_label': 'قناة اليوتيوب',
      'office_address_label': 'عنوان المكتب الرئيسي',
      'office_address_value': 'تبليسي، جورجيا (Tbilisi, Georgia)',
      'apartment': 'شقة كاملة',
      ...
      'chat_guest_login_prompt': 'يرجى تسجيل الدخول أو إنشاء حساب للتواصل المباشر مع خدمة العملاء وحفظ محادثتك.',
    ...
    'en': {
      ...
      'direct_service_title': 'Direct Request & Contact',
      'direct_service_desc': 'This service does not require filling a form. You can contact support directly or submit an instant request.',
      'direct_order_btn': 'Submit Instant Request',
      'contact_whatsapp': 'WhatsApp Contact',
      'contact_chat': 'Support Live Chat',
      'optional_notes': 'Additional notes (Optional)',
      'service_order_success': 'Your request has been submitted successfully!',
      'app_title': 'ABSHER',
      'welcome': 'Welcome,',
      'home': 'Home',
      'services': 'Services',
      ...
      'delete_all_notifs': 'Clear All Notifications',
      'delete_all_confirm_title': 'Clear All Notifications',
      'delete_all_confirm_msg': 'Are you sure you want to delete all notifications?',
      'delete_notif_success': 'Notification deleted',
      'delete_all_notifs_success': 'All notifications cleared successfully',
      'delete_notif_btn': 'Delete',
      ...
      'about_description':
          'Absher Group - Your gateway to studying and living in Georgia. Helping Arab & international students with university admissions, housing, and comprehensive student services from arrival to graduation.',
      'supported_languages_title': 'Supported Languages',
      'contact_us_title': 'Official Contact Channels',
      'website_label': 'Official Website',
      'whatsapp_label': 'WhatsApp & Phone',
      'instagram_label': 'Instagram',
      'facebook_label': 'Facebook Page',
      'tiktok_label': 'TikTok',
      'youtube_label': 'YouTube Channel',
      'office_address_label': 'Head Office Address',
      'office_address_value': 'Tbilisi, Georgia',
      ...
      'chat_guest_login_prompt': 'Please log in or create an account to chat directly with customer support.',
