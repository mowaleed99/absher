...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _fetchProfile() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _errorMessage = LanguageService.tr('failed_load_profile');
          _isLoading = false;
        });
      }
    }
    ...
    try {
      ...
      showDialog(
        ...
        builder: (dialogCtx) => AlertDialog(
          title: Text(LanguageService.tr('confirm_avatar_title')),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text(LanguageService.tr('confirm_avatar_desc')),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: Text(LanguageService.tr('confirm')),
            ),
          ],
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(LanguageService.tr('image_pick_error'))),
      );
    }
  }
    ...
    try {
      ...
      if (mounted) {
        ...
        if (result['success'] == true && result['avatar_url'] != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
                content: Text(result['message'] ?? 'تم تحديث الصورة بنجاح'),
                backgroundColor: AppColors.success),
          );
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
                content: Text(result['message'] ?? 'فشل رفع الصورة الشخصية'),
      ...
      builder: (_) => AlertDialog(
        title: Row(
          children: [
            ...
            Text(LanguageService.tr('change_lang'),
                style:
        ...
        content: Column(
          ...
          children: [
            _buildLangOption(
                context, 'ar', LanguageService.tr('auto_trans_1203')),
            _buildLangOption(
                context, 'en', LanguageService.tr('auto_trans_1204')),
          ],
        ),
      ),
    );
  ...
  Widget _buildAvatarWidget() {
    ...
    if (_student?.avatarUrl != null && _student!.avatarUrl!.isNotEmpty) {
      ...
      final fullUrl =
          '$resolvedUrl${resolvedUrl.contains('?') ? '&' : '?'}t=$_avatarTimestamp';
                          ...
                          children: [
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(LanguageService.tr('guest_mode'),
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                              ...
                              child: ListTile(
                                ...
                                leading: const CircleAvatar(
                                    ...
                                    child: Icon(Icons.language,
                                        color: AppColors.textDark)),
                                title: Text(LanguageService.tr('change_lang'),
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 15,
                                        color: AppColors.textDark)),
                                subtitle: Text(LanguageService.tr('lang_desc'),
                                    style: const TextStyle(
                                        fontSize: 11,
                                        color: AppColors.textMuted)),
                                trailing: Icon(
                            ...
                            if (!widget.isGuest) ...[
                              _buildProfileItem(
                                context,
                                Icons.edit,
                                LanguageService.tr('edit_profile_title'),
                                LanguageService.tr('edit_profile_sub'),
                                onTap: () async {
                              ...
                              _buildProfileItem(
                                context,
                                Icons.lock_outline,
                                LanguageService.tr('change_password'),
                                LanguageService.tr('change_password_sub'),
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                            ...
                            _buildProfileItem(
                              ...
                              LanguageService.tr('my_bookings'),
                              LanguageService.tr('booking_status_subtitle'),
                              onTap: () {
                                if (!widget.isGuest) {
                                  Navigator.push(
                                    context,
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                ...
                                label: Text(
                                    widget.isGuest
                                        ? LanguageService.tr('guest_logout')
      ...
      child: ListTile(
        ...
        onTap: onTap ??
            () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('${LanguageService.tr('clicked_on')} $title'))),
      ),
    );
  }
}
