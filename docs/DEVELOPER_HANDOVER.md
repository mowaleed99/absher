...
> هذا الدليل مرجع هندسي شامل يوثق بنية النظام بالكامل. يُرجى قراءة هذا الملف بعناية فائقة قبل إجراء أي تعديل.

---

> [!IMPORTANT]
> ## 📌 القاعدة الأهم — اكملها كما بدأت، لا تغيّر كل شيء
>
> **المشروع جاهز وشغّال بالكامل على الإنتاج.** مهمتك إنك **تكمل** على نفس الأسلوب والنمط الموجود — مش تعيد تصميم أو تغيّر هيكل المشروع.
>
> - **لا تغيّر CSS الـ Design System** (`admin_react/src/style.css`) — الألوان والتصميم والـ dark mode محدد ومتفق عليه.
> - **لا تغيّر هيكل الـ i18n** — أي نص جديد في الـ UI يتضاف بالطريقة الموجودة (key عربي + key إنجليزي).
> - **لا تغيّر بنية قاعدة البيانات** بدون تطبيق migration على كلا البيئتين.
> - **لا تضيف مكتبات جديدة** بدون ضرورة — المشروع عمداً خالي من تبعيات غير ضرورية.
> - **لا تعيد كتابة modules موجودة** — أضف فوقها أو عدّل فيها بنفس الأسلوب.
>
> **الهدف:** لو حد شاف شغلك، يحس إن نفس المبرمج الأول اللي بدأ المشروع هو اللي كمّله.
