...
if match:
    ...
    additions = {
        'customer_service_shield': ('🛡️ خدمة العملاء (أبشر)', '🛡️ Customer Service (Absher)'),
        'chat_img_att': ('📷 صورة مرفقة من خدمة العملاء (أبشر)', '📷 Attached image from Customer Service (Absher)')
    }
    ...
    with open('backend_php/admin/lang.js', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print('Added emoji strings to lang.js!')
else:
